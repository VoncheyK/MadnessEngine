...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'bamfor': // for disruption, would be cool i think -nintendofan44
				tex = Paths.getSparrowAtlas('$path/bamfor', 'shared');
				frames = tex;
			...
			case 'gf':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('$path/GF_assets', 'shared');
				frames = tex;
			...
			case 'gf-christmas':
				tex = Paths.getSparrowAtlas('$path/gfChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-car':
				tex = Paths.getSparrowAtlas('$path/gfCar', 'shared');
				frames = tex;
			...
			case 'gf-pixel':
				tex = Paths.getSparrowAtlas('$path/gfPixel', 'shared');
				frames = tex;
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('$path/DADDY_DEAREST', 'shared');
				frames = tex;
				...
				playAnim('idle');
			case 'spooky':
				tex = Paths.getSparrowAtlas('$path/spooky_kids_assets', 'shared');
				frames = tex;
				...
				playAnim('danceRight');
			case 'mom':
				tex = Paths.getSparrowAtlas('$path/Mom_Assets', 'shared');
				frames = tex;
			...
			case 'mom-car':
				tex = Paths.getSparrowAtlas('$path/momCar', 'shared');
				frames = tex;
				...
				playAnim('idle');
			case 'monster':
				tex = Paths.getSparrowAtlas('$path/Monster_Assets', 'shared');
				frames = tex;
			...
			case 'monster-christmas':
				tex = Paths.getSparrowAtlas('$path/monsterChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
				...
				playAnim('idle');
			case 'pico':
				tex = Paths.getSparrowAtlas('$path/Pico_FNF_assetss', 'shared');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('$path/BOYFRIEND', 'shared');
				frames = tex;
			...
			case 'bf-christmas':
				var tex = Paths.getSparrowAtlas('$path/bfChristmas', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-car':
				var tex = Paths.getSparrowAtlas('$path/bfCar', 'shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				...
				flipX = true;
			case 'bf-pixel':
				frames = Paths.getSparrowAtlas('$path/bfPixel', 'shared');
				...
				flipX = true;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('$path/bfPixelsDEAD', 'shared');
			...
			case 'senpai':
				frames = Paths.getSparrowAtlas('$path/senpai', 'shared');
			...
			case 'spirit':
				frames = Paths.getPackerAtlas('$path/spirit', 'shared');
			...
			case 'parents-christmas':
				frames = Paths.getSparrowAtlas('$path/mom_dad_christmas_assets', 'shared');
