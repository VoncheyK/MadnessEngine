...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    var loginButtons:FlxTypedGroup<FlxUIButton>;
    var usernameText:FlxText;
    var tokenText:FlxText;
    var usernameBox:FlxUIInputText;
    var tokenBox:FlxUIInputText;
    var signInBox:FlxUIButton;
    var helpBox:FlxUIButton;
    var logOutBox:FlxUIButton;
    var cancelBox:FlxUIButton;
    ...
    override function create()
    {
        ...
        loginButtons = new FlxTypedGroup<FlxUIButton>(3);
        add(loginButtons);

        signInBox = new FlxUIButton(0, 475, "Sign In", function(){
            trace(usernameBox.text);
            trace(tokenBox.text);
            GameJoltAPI.authDaUser(usernameBox.text, tokenBox.text, true);
        });

        signInBox.label.font = GameJoltInfo.font;
        signInBox.label.autoSize = true;


        helpBox = new FlxUIButton(0, 550, "GameJolt Token", function(){
        ...
        helpBox.label.font = GameJoltInfo.font;
        helpBox.label.autoSize = true;

        logOutBox = new FlxUIButton(0, 625, "Log Out & Close", function()
            {
                GameJoltAPI.deAuthDaUser();
            });
        
        logOutBox.color = FlxColor.RED;
        logOutBox.label.font = GameJoltInfo.font;
        logOutBox.label.autoSize = true;

        cancelBox = new FlxUIButton(0,625, "Not Right Now", function()
        {
            FlxG.save.flush();
        ...
        cancelBox.label.font = GameJoltInfo.font;
        cancelBox.label.autoSize = true;
        ...
        if(GameJoltAPI.getStatus())
        {
            username1 = new FlxText(0, 95, 0, "Signed in as:", 40, true);
            ...
            username2 = new FlxText(0, 145, 0, "" + GameJoltAPI.getUserInfo(true) + "", 40, true);
