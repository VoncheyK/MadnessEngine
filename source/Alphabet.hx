...
class Alphabet extends FlxSpriteGroup
{
	...
	inline public static function setDialogueSound(name:String = '')
	{
		...
		soundDialog = Sound.fromFile(Paths.sound(name));
		if(soundDialog == null) soundDialog = Sound.fromFile(Paths.sound('dialogue'));
	}
	...
	override function update(elapsed:Float)
	{
		...
		final lerpVal:Float = CoolUtil.bound(elapsed * 9.6, 0, 1);
		if (isMenuItem)
		{
