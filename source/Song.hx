...
class Song
{
	...
	public static function loadFromJson(jsonInput:String, ?folder:String, ?mod:String):SwaggiestSong
	{
		var rawJson = Assets.getText(Paths.json(folder.toLowerCase() + '/' + jsonInput.toLowerCase(), null, mod)).trim();
